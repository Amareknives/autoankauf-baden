...
export const metadata: Metadata = {
  title: 'Datenschutzerklärung | AutoAnkauf-Baden',
  description:
    'Datenschutzerklärung von AutoAnkauf-Baden gemäß DSGVO – transparent und verständlich erklärt.',
...
<p>autoankauf-baden.de<br />Muhammet Demir<br />Heidelberger Str. 4<br />76676 Graben-Neudorf<br />Baden-W&uuml;rttemberg, Deutschland</p>
<p>Telefon: 017624196168<br />E-Mail: info@autoankauf-baden.de</p>
...
<p>Sofern weitere Cookies und Dienste auf dieser Website eingesetzt werden, k&ouml;nnen Sie dies dieser Datenschutzerkl&auml;rung entnehmen.</p>
...
<p>Wenn das Social-Media-Element aktiv ist, wird eine direkte Verbindung zwischen Ihrem Endger&auml;t und dem X-Server hergestellt. X (ehemals Twitter) erh&auml;lt dadurch Informationen &uuml;ber den Besuch dieser Website durch Sie. Die Nutzung dieses Dienstes erfolgt auf Grundlage Ihrer Einwilligung nach Art. 6 Abs. 1 lit. a DSGVO und &sect; 25 Abs. 1 TDDDG. Die Einwilligung ist jederzeit widerrufbar.</p>
<h3>Instagram</h3>
...
<p>Wenn das Social-Media-Element aktiv ist, wird eine direkte Verbindung zwischen Ihrem Endger&auml;t und dem Instagram-Server hergestellt. Instagram erh&auml;lt dadurch Informationen &uuml;ber den Besuch dieser Website durch Sie. Die Nutzung dieses Dienstes erfolgt auf Grundlage Ihrer Einwilligung nach Art. 6 Abs. 1 lit. a DSGVO und &sect; 25 Abs. 1 TDDDG. Die Einwilligung ist jederzeit widerrufbar.</p>

<h2>6. Analyse-Tools und Werbung</h2>
<h3>Google Tag Manager</h3>
<p>Wir setzen den Google Tag Manager ein. Anbieter ist die Google Ireland Limited, Gordon House, Barrow Street, Dublin 4, Irland.</p>
<p>Der Google Tag Manager ist ein Tool, das es uns erlaubt, Tracking- oder Statistik-Tools und andere Technologien auf unserer Website einzubinden. Der Google Tag Manager selbst erstellt keine Nutzerprofile, speichert keine Cookies und nimmt keine eigenst&auml;ndigen Analysen vor. Er dient nur der Verwaltung und Ausspielung der &uuml;ber ihn eingebundenen Tools.</p>
<p>Der Einsatz des Google Tag Managers erfolgt auf Grundlage von Art. 6 Abs. 1 lit. f DSGVO. Sofern eine entsprechende Einwilligung abgefragt wurde, erfolgt die Verarbeitung ausschlie&szlig;lich auf Grundlage von Art. 6 Abs. 1 lit. a DSGVO; die Einwilligung ist jederzeit widerrufbar. Wir nutzen den Google Tag Manager in Verbindung mit Cookiebot, um sicherzustellen, dass Tags erst nach erteilter Einwilligung ausgel&ouml;st werden (Consent Mode v2).</p>
<h3>IONOS WebAnalytics</h3>
<p>Diese Website nutzt die Analysedienste von IONOS WebAnalytics (im Folgenden: IONOS). Anbieter ist die 1&amp;1 IONOS SE, Elgendorfer Stra&szlig;e 57, D &ndash; 56410 Montabaur. Im Rahmen der Analysen mit IONOS k&ouml;nnen u.&nbsp;a. Besucherzahlen und &ndash;verhalten (z.&nbsp;B. Anzahl der Seitenaufrufe, Dauer eines Webseitenbesuchs, Absprungraten), Besucherquellen, Besucherstandorte sowie technische Daten (Browser- und Betriebssystemversionen) analysiert werden.</p>
...
<p>Die Speicherung und Analyse der Daten erfolgt auf Grundlage von Art. 6 Abs. 1 lit. f DSGVO. Der Websitebetreiber hat ein berechtigtes Interesse an der statistischen Analyse des Nutzerverhaltens, um sowohl sein Webangebot als auch seine Werbung zu optimieren.</p>
<h4>Auftragsverarbeitung</h4>
<p>Wir haben einen Vertrag &uuml;ber Auftragsverarbeitung (AVV) zur Nutzung des oben genannten Dienstes geschlossen. Hierbei handelt es sich um einen datenschutzrechtlich vorgeschriebenen Vertrag, der gew&auml;hrleistet, dass dieser die personenbezogenen Daten unserer Websitebesucher nur nach unseren Weisungen und unter Einhaltung der DSGVO verarbeitet.</p>
...
<p>Wir nutzen YouTube im erweiterten Datenschutzmodus. Videos, die im erweiterten Datenschutzmodus abgespielt werden, werden nach Aussage von YouTube nicht zur Personalisierung des Surfens auf YouTube eingesetzt. Die Nutzung von YouTube erfolgt im Interesse einer ansprechenden Darstellung unserer Online-Angebote. Dies stellt ein berechtigtes Interesse im Sinne von Art. 6 Abs. 1 lit. f DSGVO dar. Sofern eine entsprechende Einwilligung abgefragt wurde, erfolgt die Verarbeitung ausschlie&szlig;lich auf Grundlage von Art. 6 Abs. 1 lit. a DSGVO und &sect; 25 Abs. 1 TDDDG. Die Einwilligung ist jederzeit widerrufbar.</p>
...
<p>Zur Nutzung der Funktionen von Google Maps ist es notwendig, Ihre IP-Adresse zu speichern. Diese Informationen werden in der Regel an einen Server von Google in den USA &uuml;bertragen und dort gespeichert. Die Nutzung von Google Maps erfolgt im Interesse einer ansprechenden Darstellung unserer Online-Angebote und an einer leichten Auffindbarkeit der von uns auf der Website angegebenen Orte. Dies stellt ein berechtigtes Interesse im Sinne von Art. 6 Abs. 1 lit. f DSGVO dar. Sofern eine entsprechende Einwilligung abgefragt wurde, erfolgt die Verarbeitung ausschlie&szlig;lich auf Grundlage von Art. 6 Abs. 1 lit. a DSGVO und &sect; 25 Abs. 1 TDDDG. Die Einwilligung ist jederzeit widerrufbar.</p>
...
<p style="margin-top:2rem; font-size: 0.75rem; color: #94A3B8;">Quelle: <a href="https://www.e-recht24.de" target="_blank" rel="noopener noreferrer" style="color:#94A3B8;">e-recht24.de</a></p>
`
    ...
    <div className="min-h-screen bg-[#F8FAFC]">
      ...
      <div className="bg-[#0369A1] py-12">
        <div className="container mx-auto px-4 md:px-6 lg:px-8 max-w-3xl">
          ...
          <h1 className="text-3xl md:text-4xl font-black text-white">Datenschutzerklärung</h1>
        </div>
      </div>
      ...
      <div className="container mx-auto px-4 md:px-6 lg:px-8 max-w-3xl py-12">
        ...
        <div className="bg-white rounded-2xl border border-[#E2EDF7] p-8 md:p-10 datenschutz-content">
