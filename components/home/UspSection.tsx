...
const usps = [
  {
    ...
    bg: '#E8F4FD',
    title: 'Ehrlich & fair',
    text: 'Keine versteckten Abzüge – du weißt immer, wie dein Preis zustande kommt.',
  },
  {
    icon: Zap,
    color: '#0EA5E9',
  ...
  },
  {
    ...
    text: 'Du bekommst dein Geld direkt beim Termin – bar auf die Hand.',
  },
  {
    icon: MapPin,
    color: '#FB6F6F',
    ...
    text: 'Wir kommen zu dir – kostenlos in ganz Baden, der Pfalz und der Region.',
  },
]
      ...
      <div className="container mx-auto px-4 md:px-6 lg:px-8">
        ...
        <div className="text-center mb-8 md:mb-12">
          ...
          <p className="text-[#64748B] text-sm md:text-base max-w-xl mx-auto leading-relaxed">
            Egal welche Marke, welcher Kilometerstand oder Zustand – wir kaufen dein Auto in ganz Baden fair an und zahlen sofort bar.
          </p>
        </div>
          ...
          {usps.map((usp) => {
            ...
            return (
              ...
              >
                ...
                <p className="text-xs md:text-sm text-[#64748B] leading-relaxed">{usp.text}</p>
              </div>
            )
          })}
        </div>
